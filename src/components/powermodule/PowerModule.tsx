...
const PowerModule = (props: PowerModuleProps) => {
  ...
  return (
    ...
    <div>
      ...
      <div id="Layer2" style="position:relative; left:137px; top:77px; width:136px; height:132px; z-index:2">
      ...
      <div id="Layer1" style="position:absolute; left:195px; top:110px; width:64px; height:58px; z-index:1">
